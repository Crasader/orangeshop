            ...
            <div class="box-body">
                <div class="col-xs-12">
                    ...
                    <form class="form-horizontal"
                          action="{{ route('promotion_suit.update',['id'=>$promotion_suit->pm_id]) }}"
                          id="promotion_suit"
                          method="post">
                        {{ csrf_field() }}
                        {{ method_field('put') }}
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control"
                                       name="name" value="{{ $promotion_suit->name }}">
                            </div>
                        </div>
                            ...
                            <div class="col-sm-4">
                                <div class="input-group date">
                                    ...
                                    <input type="datetime" name="start_time" class="form-control pull-right"
                                           id="start"
                                           data-date-format="yyyy-mm-dd hh:ii:ss" value="{{ $promotion_suit->start_time }}">
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="input-group date">
                                    ...
                                    <input type="datetime" name="end_time" class="form-control pull-right" id="end"
                                           data-date-format="yyyy-mm-dd hh:ii:ss" value="{{ $promotion_suit->end_time }}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <label class="control-label">
                                    <input type="radio" name="state" value="1" @if($promotion_suit->state == 1) checked @endif>开启
                                </label>
                                <label class="control-label">
                                    <input type="radio" name="state" value="0" @if($promotion_suit->state == 0) checked @endif>关闭
                                </label>
                            </div>
                        </div>
