        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                <div class="col-xs-12">
                    ...
                    <form class="form-horizontal" action="{{ route('promotion_full_send.store') }}" id="promotion_full_send"
                          method="post">
                        {{ csrf_field() }}
                        <div class="form-group">
                            <label class="col-sm-2 control-label">满赠活动名</label>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" placeholder="限额"
                                       name="limit_money" value="{{ old('limit_money','') }}">
                            </div>
                        </div>
