...
@section('head')
    <link href="/index/css/sortstyle.css" rel="stylesheet" type="text/css"/>
@stop
                    ...
                    <ul class="category-list" id="js_climit_li">
                        <li class="appliance js_toggle relative first selected">
                            <div class="category-info">
                                <h3 class="category-name b-category-name"><i><img src="/index/images/cake.png"></i><a
                        ...
                        <li class="appliance js_toggle relative">
                            <div class="category-info">
                                <h3 class="category-name b-category-name"><i><img src="/index/images/cookies.png"></i><a
                        ...
                        <li class="appliance js_toggle relative">
                            <div class="category-info">
                                <h3 class="category-name b-category-name"><i><img src="/index/images/meat.png"></i><a
                        ...
                        <li class="appliance js_toggle relative">
                            <div class="category-info">
                                <h3 class="category-name b-category-name"><i><img src="/index/images/bamboo.png"></i><a
                        ...
                        <li class="appliance js_toggle relative">
                            <div class="category-info">
                                <h3 class="category-name b-category-name"><i><img src="/index/images/nut.png"></i><a
                        ...
                        <li class="appliance js_toggle relative">
                            <div class="category-info">
                                <h3 class="category-name b-category-name"><i><img src="/index/images/candy.png"></i><a
                        ...
                        <li class="appliance js_toggle relative">
                            <div class="category-info">
                                <h3 class="category-name b-category-name"><i><img src="/index/images/chocolate.png"></i><a
                        ...
                        <li class="appliance js_toggle relative">
                            <div class="category-info">
                                <h3 class="category-name b-category-name"><i><img src="/index/images/fish.png"></i><a
                        ...
                        <li class="appliance js_toggle relative">
                            <div class="category-info">
                                <h3 class="category-name b-category-name"><i><img src="/index/images/tea.png"></i><a
                        ...
                        <li class="appliance js_toggle relative last">
                            <div class="category-info">
                                <h3 class="category-name b-category-name"><i><img src="/index/images/package.png"></i><a
